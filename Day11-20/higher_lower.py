...
def select_choices(a, b):
    '''Moves choice B into choice A, picks a random choice B while checking to make sure they are not equal.'''
    a = b
...
def compare_followers(player_choice, score):
    '''Game logic for determining if player choice is higher or lower than the other option'''
    if player_choice == 'a':
