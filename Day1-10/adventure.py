...
so there's no way to see what lies further ahead. The choice is yours...
"left" or "right"?
''')
...
No way to discern if they are friend or foe, you can either stick around to
find out, or you could try to swim to the distant island on your own.
"swim" or "wait", the choice is yours...
''')
    if swim_wait.lower() == 'wait':
        rby = input('''
The ferryman approaches and offers you passage in return for a small cut of
your findings. You hastily agree and hop on board.
After reaching the other side you descend into the cave and see three colored
tunnels. Any or all of them could contain treasure.
...
You are destined to die here, frozen just mere feet away from the sapphire
you came here for.
Game Over.
            ''')
        elif rby.lower() == 'yellow':
            print('''
Making your way through the yellow hall, you see the diamond at the end on a
pedestal. Your curious brain notices there's a boulder set to spring forth as
soon as the gem is taken. You decide to tell the ferryman about the treasure.
He grabs the diamond, and laughs saying he's going to keep the whole thing and
that you are a fool.
WHAM!
The boulder crushes him, the diamond falling to the floor.
You pick it up and leave the island, sailing back on his ship and never
telling anyone what happened that day.
You Win!
            ''')
        else:
            print('''
You indecision keeps you from choosing a tunnel, and you sit podering for
eternity. That is until a pack of hungry wolves find you in their cave.
